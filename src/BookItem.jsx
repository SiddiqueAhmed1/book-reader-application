                ...
                <Fragment key={book.id}>
                  <div className="bookList flex   my-5 border border-gray-700 rounded-md bg-indigo-800 w-[650px] mx-auto  p-2 px-6 items-center gap-2">
                    ...
                    <div className=" w-[18%] mx-1">
                      {book.isRead === true ? (
                        <button className="bg-pink-700 py-1 w-fullcursor-pointer px-4 border border-pink-700 hover:bg-pink-800 rounded-md text-xl">
                          Unread
                        </button>
                      ) : (
                        <button className="bg-teal-600 py-1 w-full cursor-pointer px-4 border border-teal-600 hover:bg-teal-700 rounded-md text-xl">
                          Read
                        </button>
                      )}
                    </div>
